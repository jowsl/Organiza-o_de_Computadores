...
#define N_FOR  4     //numero de instrucoes que vao se repetir
#define N_MEM 900   //numero da memoria para endereco do bloco
#define N_PROB 90      //probabilidade de repeticao
#define N_OPCODE 3   //numero maximo de opcodes //!Eram 4 alterei pra 2
